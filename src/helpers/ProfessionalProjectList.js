...
export const ProfessionalProjectList = [
    {
        ...
        outcome: "The new app was well-received, and we were able to retire the original app soon after the new one launched.",
        tags: ['Angular', 'Express', 'Sequelize', 'Web', 'App', 'Team']
    },
    {
        name: "Delphi Panel App",
        tech: "Angular, NodeJS, Express, PostgreSQL",
        highlights: "This app has been used to conduct Delphi panels, several of which have been published in peer-reviewed scientific journals.",
        ...
        development: "The app and APIs are divided into Study Coordinator, Client and Participant-facing versions to maintain appropriate content restrictions for each user, as perserving participant anonymity is a core element of Delphi methodology. The app automates calculation of survey round results using raw SQL queries whenever a response is submitted. I added functionality for study coordinators to preview the participant view of the app by using Puppeteer to crawl the app and create PDF screenshots.",
        outcome: "The app has been used to conduct Delphi panels for Costello Medical's clients since its launch in 2021.",
    ...
    },
    {
        ...
        objectives: "To migrate from a manual, IT service ticket-based method of approving folder access requests to a self-service system.",
    ...
    },
    {
        ...
        development: "I supervised development and assisted with writing more complex front-end components and database queries, including creating custom SQL functions to conduct searches across database tables and columns. The scope of the app changed during development so I made adjustments to replace certain features so we could stay on schedule.",
